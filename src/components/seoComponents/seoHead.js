...
//canonicalUrl wird angegeben als https://... und die Index Seite.
  ...
  return(
    ...
    <Head>
         //basic metadata
         <title>{title ? (title + " Strohhalm aus Reisstärke") : (siteMetadata.title)}</title>
         <meta
             name="viewport"
         ...
         //Basic metadata
         <meta name="title" content={title ? (title + " Strohhalm aus Reisstärke") : (siteMetadata.title)} key="title" />
         ...
         <meta name="twitter:title" content={title ? (title + " Strohhalm aus Reisstärke") : (siteMetadata.title)} />
         ...
         <meta property="og:title" content={title ? (title + " Strohhalm aus Reisstärke") : (siteMetadata.title)} />
